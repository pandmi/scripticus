...
def bidder_strategy_target(strategy_ids, bidder_number, bidder_location, sec):
    ...
    for  count, strategy_id in enumerate(strategy_ids,1):
        ...
        url_bidder_sts = 'http://{}-bidder-x{}.ams.mmracks.internal:8081/strategy_target?op=create&strategy={}&max_recs=&max_runtime=1500&stop=&fmt=json'.format(bidder_location,bidder_number, strategy_id)
        ...
        try:   
            ...
            time.sleep(sec)
            url_bidder_stf = 'http://{}-bidder-x{}.ams.mmracks.internal:8081/strategy_target?op=report&fmt=json&test_id={}&strategy={}&stop='.format(bidder_location,bidder_number, test_id, strategy_id)

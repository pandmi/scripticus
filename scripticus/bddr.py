...
def bidder_strategy_target(strategy_ids, bidder_number, bidder_location, sec):
    ...
    for strategy_id in strategy_ids:
        ...
        # df_final.drop(['targeting_dimension'], axis=0)  
        # col = df_final.pop("Overall")
        # df_final = df_final.insert(0, col.name, col) 
            
         

    return df_final

# def bidder_strategy_target(strategy_id, bidder_number, bidder_location, sec):

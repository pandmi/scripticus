...
def bidder_strategy_target(strategy_ids, bidder_number, bidder_location, sec):
    ...
    for  count, strategy_id in enumerate(strategy_ids,1):
        ...
        try:   
            ...
            time.sleep(sec)
            url_bidder_stf = 'http://{}-bidder-x{}.mediamath.com:8081/strategy_target?op=report&fmt=json&test_id={}&strategy={}&stop='.format(bidder_location,bidder_number, test_id, strategy_id)
